...
namespace Client
{
    public class OfflineBonusSystem : IEcsInitSystem, IEcsRunSystem
    {
        ...
        public void Init()
        {
            ...
            reward = sec * _gameData.PlayerData.MoneyInSec * Mathf.Pow(GameData.Instance.BalanceData.EarningOfflineMultiplierForLevel, _gameData.PlayerData.EarnOfflineUpgrade.Level);
