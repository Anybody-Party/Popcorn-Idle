...
public class GameScreen : BaseScreen
{
    ...
    [SerializeField] private DynamicString levelDynamicString;
    [SerializeField] private TextMeshProUGUI moneyText;
    [SerializeField] private TextMeshProUGUI moneyInSecText;
    [SerializeField] private DynamicString moneyInSecDynamicString;
    ...
    public void UpdateLevelText(int _level)
    {
        ...
        levelDynamicString.UpdateString(_level + 1);
    }

    public void UpdateMoneyText(double _moneyCount) => moneyText.text = $"<sprite=0> {Utility.FormatMoney(_moneyCount)}"; // money sprite

    public void UpdateMoneyInSecText(double _moneyInSecCount) => moneyInSecDynamicString.UpdateString(Utility.FormatMoney(_moneyInSecCount));
